...
<xsl:param name="delimiter" select=" '|' "/>
	...
	<xsl:template match="/">
	<xsl:text>Base|Reference Order|Reference Authors|Reference Publisher|Reference Editor|Reference Publication|Reference Article|Reference Volume|Reference Year|Reference Type|References PubMed ID|References PubMed ID URL|References DOI|References DOI URL|References Pages|References External Reference URL</xsl:text>
<xsl:text>&#13;&#10;</xsl:text>
...
<xsl:value-of select="normalize-space(ReferenceOrder)"/>
<xsl:value-of select="$delimiter"/>
