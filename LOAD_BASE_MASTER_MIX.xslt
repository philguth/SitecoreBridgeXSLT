...
<xsl:param name="delimiter" select=" '|' "/>
	...
	<xsl:template match="/">
	<xsl:text>SKU|Master Mix of is NEB Product|Master Mix of NEB Product|Reaction Volume Definition|Concentration Usage Factor Supplied|Concentration Usage</xsl:text>
<xsl:text>&#13;&#10;</xsl:text>
