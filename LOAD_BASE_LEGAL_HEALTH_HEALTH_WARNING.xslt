...
<xsl:param name="delimiter" select=" '|' "/>
	...
	<xsl:template match="/">
	<xsl:text>Base|Health Warning Title|Health Warning Web Page Content|Health Warning Data Card Content|Health Warning Catalog Page Content|Health Warning Marketing Literature Content</xsl:text>
<xsl:text>&#13;&#10;</xsl:text>
<xsl:for-each select="/ProductDetailsBySku/ProductDetailsBySku/LegalAndHealth/healthwarning/BoilerplateItem">
