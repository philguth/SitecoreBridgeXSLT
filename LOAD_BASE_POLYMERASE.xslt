...
<xsl:param name="delimiter" select=" '|' "/>
	...
	<xsl:template match="/">
	<xsl:text>SKU|Fidelity vs Taq|Polymerase Type|Kit Available|KmDNA|KmDNA UOM|KmDNTPs|KmDNTPs UOM|Longest Primer Extension|Longest Primer Extension UOM|Strand Displacement|Overall Thermal Stability|Exonuclease 3-5|Exonuclease 5-3|Amplicon Size|Direct Gel Loading|Error Rate Selector|Error Rate value|Error Rate power|Extend RNA Primer|Extension from Nick|Extension Rate</xsl:text>
<xsl:text>&#13;&#10;</xsl:text>
